...
void test_enqueue_heap() {
  ...
  // test
  assert(count_heap_elements() == 0);
  enqueue_heap(1.0);
  assert(count_heap_elements() == 1);
...
void test_queue_maintains_internal_order() {
  // setup
  reset_heap();
  double values[6] = {1.715646, 0.763207, 1.044174,
                      1.336052, 1.487733, 0.851104};
  for (int i = 0; i < 6; i++) {
